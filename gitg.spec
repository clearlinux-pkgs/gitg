...
Version  : 3.32.0
Release  : 6
URL      : https://github.com/GNOME/gitg/archive/v3.32.0/gitg-3.32.0.tar.gz
Source0  : https://github.com/GNOME/gitg/archive/v3.32.0/gitg-3.32.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1559328464
export AR=gcc-ar
